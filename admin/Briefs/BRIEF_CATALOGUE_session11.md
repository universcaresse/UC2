...
## PAGE 1 — COUVERTURE — CORRECTIONS DÉCIDÉES

| # | Décision | Date |
|---|----------|------|
| 1 | Supprimer `.cover-overlay` du HTML — div vide sans style, inutile | 2026-04-12 |
| 2 | Photo de couverture → vient de la médiathèque via `getMediatheque` | 2026-04-12 |
| 3 | Fond perdu à éliminer — même visuel écran qu'impression (marges normales) | 2026-04-12 |
| 4 | Logo à agrandir significativement — actuellement 200px, trop petit | 2026-04-12 |
| 5 | Nom de chaque collection affiché à gauche de son carré de couleur, texte blanc uppercase | 2026-04-12 |
...
| 11 | 2026-04-12 | Analyse complète 4 fichiers + code.gs, décisions page 1 couverture, protocole fichiers |
