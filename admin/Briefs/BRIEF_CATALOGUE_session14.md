...
**Session 14 — À lire en entier avant de commencer**
**Dernière mise à jour : 2026-04-12 — session 14**
...
2. Demander les fichiers un à la fois dans cet ordre — lire au complet avant d'en demander un autre :
   1. `catalogue.html`
   2. `catalogue.js`
   3. `catalogue.css`
   4. `style.css`
...
- **Exception** : au centre du 11×17 (pliure/reliure) — les deux pages se touchent sans marge perdue
...
### Ce qui fonctionne
- Photo de couverture pleine page, forte, avec masque dégradé radial sur les bords
- Marge sur 3 côtés (haut, bas, droite) — gauche = 0 (reliure)
...
7. **Couverture — dégradé lisibilité texte sur `.cover-photo::after`** ← PROCHAIN
8. Couverture — logo grosseur
9. Couverture — bloc collections grosseur
10. Régler page Chantal (photo, proportions, pied de page, texte → API)
11. Valider table des matières (div #tdm-liste manquante dans HTML)
12. Valider couverture (carrés dynamiques, eyebrow)
13. Valider SAPONICA double page
14. Valider PETIT NUAGE + CAPRIN
...
*Créé : session 6 · Mis à jour : session 14 (2026-04-12)*
