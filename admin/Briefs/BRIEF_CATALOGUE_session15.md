...
**Session 15 — À lire en entier avant de commencer**
**Dernière mise à jour : 2026-04-13 — session 15**
...
| 4-5 | SAPONICA — double page, 16 produits | en cours session 15 |
...
- Photos produits carrées — respecter le ratio dans les grilles IMPORTANT
...
8. **Appliquer `.page-g/.page-d` + `.page-int` dans toutes les fonctions JS** ← EN COURS
9. Couverture — dégradé lisibilité texte sur `.cover-photo::after`
10. Couverture — logo grosseur
11. Couverture — bloc collections grosseur
12. Régler page Chantal (photo, proportions, pied de page, texte → API)
13. Valider table des matières (div #tdm-liste manquante dans HTML)
14. Valider couverture (carrés dynamiques, eyebrow)
15. Valider SAPONICA double page
