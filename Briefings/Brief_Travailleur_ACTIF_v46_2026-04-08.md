...
| `admin/index-admin.html` | ✅ IDs et textes V2 |
| `css/style.css` | ✅ En consolidation progressive |
| `js/main.js` | ✅ Réécrit V2 — audit corrections v45 |
| `js/admin.js` | ✅ Réécrit V2 — audit corrections v45 |
| `code_v2.gs` | ✅ Corrigé et redéployé 8 avril — v45 |
...
**🔴 Critiques réglés**
1. ~~`saveProduit_v2` — deleteRow avant recalcul ligneExistante — produit toujours appendé, jamais modifié~~ ✅ — suppression du deleteRow redondant — ⚠️ redéployer `code_v2.gs`
...
5. ~~Filtres Type et Fournisseur inventaire — dropdowns jamais peuplés~~ ✅ — `chargerInventaire()` peuple le filtre type, `filtrerInventaire()` reconstruit le tableau
6. ~~Filtres Statut et Source INCI — boutons sans effet~~ ✅ — `inciAppliquerFiltres(btn, groupe)` gère l'état actif + `inciConstruireAccordeons()` lit les filtres
...
*Univers Caresse — Confidentiel — v46 — 8 avril 2026*
