...
## 🚀 PRIORITÉS — PROCHAINE SESSION (13 avril 2026)

1. **Gammes** — Ajouter un filtre par collections
2. **Gammes** — Le hex par défaut (actuellement rouge) doit prendre le hex de la collection
3. **Gammes** — Afficher une ligne des produits à l'ouverture d'une gamme
4. **Achats** — Impossible de créer un non-UC en utilisant une cat UC → message d'erreur qui demande les 2
5. **Achats** — Le bouton Ajouter doit être dans la liste déroulante : si UC → demande les 2 infos ; si non-UC → la cat est déjà inscrite
6. **Import PDF** — Extraire le contenu en TXT directement au lieu de tester manuellement
7. **Factures** — Le X de fermeture du modal est en dehors du modal
8. **Inventaire** — Affiche le ID au lieu de la catégorie
9. **Lot existant** — Doit diminuer les ingrédients comme lors de la production d'un nouveau lot
10. **Catalogue** — Brancher le catalogue
11. **Recettes** — Enlever l'import recette
12. **JS** — Séparer le JS
13. **Catalogue** — Permettre la consultation sur iPad
14. **Dropdown** — Ne se ferme pas si on clique ailleurs sans choisir une action
15. **UI** — Revoir les bulles au téléchargement et les boutons réactifs lors d'une action
...
*Univers Caresse — Confidentiel — v55 — 13 avril 2026*
