...
### Admin (admin.js)
- `donneesCollections`, `donneesGammes`, `donneesProduits`, `listesDropdown` — chargés une fois au démarrage
...
| `admin/index-admin.html` | ✅ V1 copié dans UC2 — base visuelle |
| `css/style.css` | ✅ V1 copié dans UC2 — NE PAS TOUCHER |
| `js/main.js` | ✅ Réécrit V2 — livré 6 avril |
| `js/admin.js` | ✅ Réécrit V2 Passe 1 — livré 6 avril — en test |
| `code.gs` V1 | ✅ NE JAMAIS TOUCHER |
| `code_v2.gs` | ✅ Déployé — fonctionnel — projet `uc2` |
...
## 📍 OÙ ON EST RENDU — 6 avril 2026

### ✅ Fait cette session
- Décision V2 = visuel V1 + moteur V2
- `main.js` V2 livré et fonctionnel
- `admin.js` V2 Passe 1 livré — conflits de déclaration corrigés
- Admin charge sans erreur JS
- Section Produits (ex-Recettes) visible et en chargement confirmé
- Brief v34 produit
...
### 🔴 PROCHAINE ÉTAPE — Tester admin.js V2
Tester section par section dans UC2 et corriger les erreurs :
1. Section Produits — est-ce que ça charge ?
2. Section Collections — est-ce que ça affiche ?
3. Nouvelle facture — est-ce que le wizard fonctionne ?
4. Fabrication — est-ce que les lots chargent ?

### 🔴 À FAIRE APRÈS LES TESTS
- Passe 2 admin.js — nettoyage et consolidation
- INCI V2 — validerIngredientInci à implémenter proprement
- INCI V2 — join dans getCataloguePublic_v2 pour afficher les codes INCI dans le modal public
- Textes HTML admin encore en V1 ("Recettes", "Lignes") → à mettre à jour dans index-admin.html
...
M3. Tester et corriger `admin.js` section par section
...
*Univers Caresse — Confidentiel — v34 — 6 avril 2026*
