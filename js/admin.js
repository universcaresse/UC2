...
if (id === 'familles')       afficherFamilles();
  ...
  if (id === 'entrer-facture') setTimeout(efInit, 100);
}
...
ifFournisseurActif = fournisseur;
 ...
 const catId = cat_UC
   ...
   tr.innerHTML = `
      ...
      <td><input type="text" inputmode="decimal" class="form-ctrl" value="${item.prixUnitaire||''}" placeholder="0.00" style="width:80px" onchange="ifItems[${idx}].prixUnitaire=parseFloat(this.value)||0; afficherApercuItems(ifFournisseurActif); ifRecalculerSousTotal()"></td>
